...
/* Like SecondNode and SecondBiathlonToken, this is just a copy of Nodelist.sol
  for the purpose of testing contract upgrading in truffle. Do not actually deploy
  this. */
  
contract UpgradedNodelist is Ownable  {
  bool public current;
  struct Entry  {
    address addr;
    string name;
